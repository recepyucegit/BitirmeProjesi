        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Individual"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalesQuota = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 10000m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierTransactions_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "TL"),
                    ExchangeRate = table.Column<decimal>(type: "decimal(18,4)", nullable: false, defaultValue: 1m),
                    AmountInTL = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SupplierTransactionDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierTransactionDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplierTransactionDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierTransactionDetails_SupplierTransactions_SupplierTransactionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2025, 12, 19, 0, 47, 18, 589, DateTimeKind.Local).AddTicks(7027), "System Administrator", true, false, "Admin", null, null },
                    { 2, null, new DateTime(2025, 12, 19, 0, 47, 18, 589, DateTimeKind.Local).AddTicks(7039), "Şube Müdürü", true, false, "BranchManager", null, null },
                    { 3, null, new DateTime(2025, 12, 19, 0, 47, 18, 589, DateTimeKind.Local).AddTicks(7040), "Kasa Satış", true, false, "Cashier", null, null },
                    { 4, null, new DateTime(2025, 12, 19, 0, 47, 18, 589, DateTimeKind.Local).AddTicks(7041), "Depo Sorumlusu", true, false, "Warehouse", null, null },
                    { 5, null, new DateTime(2025, 12, 19, 0, 47, 18, 589, DateTimeKind.Local).AddTicks(7042), "Muhasebe", true, false, "Accounting", null, null },
                    { 6, null, new DateTime(2025, 12, 19, 0, 47, 18, 589, DateTimeKind.Local).AddTicks(7045), "Teknik Servis", true, false, "TechnicalService", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_InvoiceNumber",
                table: "Expenses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactionDetails_ProductId",
                table: "SupplierTransactionDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactionDetails_SupplierTransactionId",
                table: "SupplierTransactionDetails",
                column: "SupplierTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_EmployeeId",
                table: "SupplierTransactions",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_OrderDate",
                table: "SupplierTransactions",
                column: "OrderDate");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_OrderNumber",
                table: "SupplierTransactions",
                column: "OrderNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_Status",
                table: "SupplierTransactions",
                column: "Status");
